...
public static class ThemeColors
{
    ...
    public static class Buttons
    {
        ...
        // سایزها
        public const string PrimarySm   = "btn btn-ak-primary btn-sm";
        public const string SuccessSm   = "btn btn-ak-success btn-sm";
        public const string WarningSm   = "btn btn-ak-warning btn-sm";
        public const string DangerSm    = "btn btn-ak-danger btn-sm";
        public const string SecondarySm = "btn btn-ak-secondary btn-sm";
        public const string InfoSm      = "btn btn-ak-info btn-sm";
    }
